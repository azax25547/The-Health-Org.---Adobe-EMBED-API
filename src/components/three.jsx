  ...
  componentDidMount() {
    ...
    viewSDKClient.ready().then(() => {
      viewSDKClient.registerGetAPIHandler(
        ...
        "https://cors-anywhere.herokuapp.com/https://www.nlm.nih.gov/dr2/Psychological_Stress_Associated_with_the_COVID-19_Crisis_14.pdf",
        "Impact on Health.pdf"
      );
  ...
  render() {
    return (
      <>
        <section>
          <PdfViewer
            url="https://cors-anywhere.herokuapp.com/https://www.nlm.nih.gov/dr2/Psychological_Stress_Associated_with_the_COVID-19_Crisis_14.pdf"
            fileName="Psychological Stress with COVID-19.pdf"
          />
        </section>
