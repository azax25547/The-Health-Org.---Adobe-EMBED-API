  ...
  componentDidMount() {
    ...
    viewSDKClient.ready().then(() => {
      viewSDKClient.registerGetAPIHandler(
        ...
        "https://cors-anywhere.herokuapp.com/https://www.nlm.nih.gov/dr2/COVID-19_IMPACT_HRQOL_QUESTIONNAIRE_FINAL.pdf",
  ...
  render() {
    return (
      <>
        <section>
          <PdfViewer
            url="https://cors-anywhere.herokuapp.com/https://www.nlm.nih.gov/dr2/COVID-19_IMPACT_HRQOL_QUESTIONNAIRE_FINAL.pdf"
            fileName="Impact on Cancer Patients and Survivors.pdf"
          />
        </section>
