  ...
  componentDidMount() {
    ...
    viewSDKClient.ready().then(() => {
      viewSDKClient.registerGetAPIHandler(
        ...
        "https://cors-anywhere.herokuapp.com/https://www2.census.gov/data/experimental-data-products/household-pulse-survey/household-pulse-survey-questionnaire.pdf",
  ...
  render() {
    return (
      <>
        <section>
          <PdfViewer
            url="https://cors-anywhere.herokuapp.com/https://www2.census.gov/data/experimental-data-products/household-pulse-survey/household-pulse-survey-questionnaire.pdf"
            fileName="Household Pulse Survey.pdf"
          />
        </section>
